...
\begin{itemize}
    \item Zajtalan, kis stride esetén ($\sigma=0$, $s=16$) a Fair Mamba
          ...
          felesleges terhet jelent: a mindig jelen lévő szűrési tag
          enyhe aláilleszkedést okoz, és a struktúra nem képes teljesen
          kikapcsolni a szűrést.

    \item ETTh1/$s=1$-nél az LSTM a legjobb, mivel a kapuzási mechanizmus
    ...
    \item Mindössze 5 epoch futott, és minden konfigurációt csak egyetlen
          ...
          statisztikai szignifikanciát nem garantálja, így a bemutatott
    ...
    \item Csak $L=H=96$ horizontot vizsgáltam. A 336, 720 és 960 lépéses
          ...
          is itt kezdenek dominálni, így a jelen fejezet következtetései
    ...
    \item Két benchmark (Weather, ECL) a tanítási futamszám skálázódása
          miatt a jelen kísérleti körbe nem került be, így a dimenzió-érzékenység
    ...
    \item A hiperparaméter-érzékenység szélesebb körű vizsgálata (rejtett
          ...
          nem történt meg. A bemutatott konfiguráció ésszerű alapbeállítás,
