...
periods (faster adaptation). This behaviour is consistent with the
theoretical Kalman filter and aligns with the $0{.}706 \to 0{.}073$
$K$-gain trajectory reported in Chapter~\ref{ch:experiments}.
...
All 71 test cases pass. They are divided into two categories.

\noindent\textbf{Unit (white-box) tests}\\
...
\noindent\textbf{Integration (black-box) tests}\\
Test the full pipeline end-to-end on real historical data.
...
\begin{table}[H]
  ...
  \begin{tabular}{|l|l|p{7cm}|}
    ...
    \texttt{test\_signal\_diagnostics.py} & 8 & Full prediction chain end-to-end \\
    \hline
  \end{tabular}
...
\begin{table}[H]
  ...
  \begin{tabular}{|l|l|l|}
    ...
    RAM              & 4~GB                   & 8~GB \\
    Disk             & 2~GB                   & 5~GB \\
    GPU (optional)   & n.a.                   & NVIDIA $\ge$6~GB VRAM \\
...
\subsection{Runtime messages and troubleshooting}
