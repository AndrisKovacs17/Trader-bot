...
\begin{figure}[H]
  \centering
  \includegraphics[width=\textwidth]{images/fig02_mse_heatmap_en.png}
  \caption{MSE heatmap for all four models (ARIMA, LSTM, Fair Mamba, KCMamba)
           ...
           catastrophic failure (MSE $>4$); ARIMA and Fair Mamba collapse
           completely at $s{=}16$, $\sigma{\geq}3$, while KCMamba remains
           stable throughout.}
...
\begin{figure}[H]
  ...
  \caption{Noise robustness comparison across all four models: MSE vs.\
           ...
           unstable at $s{=}16$; KCMamba and LSTM remain in a manageable
