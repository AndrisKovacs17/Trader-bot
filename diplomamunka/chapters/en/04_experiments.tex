...
\begin{table}[H]
    ...
    \begin{tabular}{|l|c|cccc|r|}
        ...
        \multirow{3}{*}{$s=1$}
            ...
            & KLA   & \textbf{0.02} & 0.50 & \textbf{0.86} & 1.23 & +5\,505\% \\
        \hline
        \multirow{3}{*}{$s=16$}
...
\begin{table}[H]
    ...
    \begin{tabular}{|l|c|cccc|r|}
        ...
        \multirow{3}{*}{$s=16$}
            ...
            & KLA   & \textbf{0.05} & \textbf{0.23} & 0.46 & 0.59 & \textbf{+982\%} \\
        \hline
    \end{tabular}
    \caption{MSE on ETTh2. KCMamba wins the $s=16$ competition at the highest noise level (0.59 vs.\ Fair 3.11).}
    \label{tab:etth2}
\end{table}
...
\begin{table}[H]
    ...
    \caption{MSE on the ETTm1 dataset across four sequence lengths.
             ...
             LSTM stagnates; Fair Mamba becomes unstable.}
