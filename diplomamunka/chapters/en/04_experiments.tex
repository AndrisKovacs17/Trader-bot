...
\begin{table}[H]
    ...
    \begin{tabular}{|c|l|cccc|}
        ...
        \multirow{3}{*}{$s=1$}
            ...
            & KLA   & \textbf{0.895} & \textbf{0.823} & \textbf{0.886} & \textbf{0.836} \\
        \hline
        \multirow{3}{*}{$s=16$}
        ...
        \multirow{3}{*}{$s=1$}
            ...
            & KLA   & \textbf{1.494} & \textbf{1.153} & 1.320 & \textbf{1.076} \\
        \hline
        \multirow{3}{*}{$s=16$}
