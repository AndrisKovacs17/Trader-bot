...
architektúra, amely a Mamba SSM~\cite{gu2023mamba} rekurráns dinamikájába
...
rekurráns dinamikájából adódó, az utolsó időlépések irányába mutató
reprezentációs torzítást; így a végső predikcióba a lassabb időskálájú
(hosszú távú) trendek is bevonhatók.

\begin{figure}[H]
  \centering
  \includegraphics[width=\textwidth]{images/fig08_architecture.png}
  \caption{A KCMamba blokk teljes adatfolyam-diagramja. A sárga blokkok
           ...
           szinkronizációval; a zöld blokkok a bemeneti/kimeneti projekciókat jelölik.}
...
mátrix ($d_\text{inner}$ a belső csatornadimenzio), $x_\text{cw}$ a
...
A végeredmény numerikusan stabil marad a fizikailag érvelmes tartományban,
...
\begin{figure}[H]
  \centering
  \includegraphics[width=\textwidth]{images/fig09_parallel_scan.png}
...
A verem $N$ rétegből áll; köztük LayerNorm rétegek (pre-norm stílus)
akadályozzák az aktivációs skála sodródását.
...
lépéseit súlyozottán erősebben kódolja, mint a régmúltat; egy hosszú-horizontú
...
\begin{figure}[H]
  \centering
  \includegraphics[width=0.95\textwidth]{images/kc_stack_diagram.png}
  \caption{A KCMamba verem (stack) felépítése. Bemenettől kimenetig:
           input projekció, 2 KC-blokk LayerNorm rétegekkel, output
           normalizáció, majd cross-attention réteg a lassú ($s=4$)
           időskála integrálásához.}
  \label{fig:stack_diagram}
\end{figure}
\begin{figure}[H]
  \centering
  \includegraphics[width=\textwidth]{images/fig11_synth_mamba.png}
...
\begin{figure}[H]
  \centering
  \includegraphics[width=\textwidth]{images/fig13_memory_retention.png}
