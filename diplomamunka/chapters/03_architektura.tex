...
Három kis, kétrétegű, teljesen összekötött MLP-alhálózat tanítja meg a Kalman-szűrő statisztikáit.
...
$K_t \approx 0$ befagyasztaná az állapotfrissítést, nem integrálódna
új információ; $K_t \approx 1$ pedig eldobná az előző lépés teljes memóriáját.
...
és egyben a lekerdezés, $h[{::s}] \in \mathbb{R}^{\lfloor T/s \rfloor \times d}$ az
$s$-adik minden pozícióból vett alámintávétel, amely a lassabb, durvább
időskálát képviselik kulcsként és értékként,
