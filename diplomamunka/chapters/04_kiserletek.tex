...
\begin{table}[H]
    ...
    \begin{tabular}{|l|c|cccc|r|}
        ...
        \multirow{3}{*}{$s=1$}
            ...
            & KCMamba   & \textbf{0.02} & 0.50 & \textbf{0.86} & 1.23 & +5\,505\% \\
        \hline
        \multirow{3}{*}{$s=16$}
...
\begin{table}[H]
    ...
    \begin{tabular}{|l|c|cccc|r|}
        ...
        \multirow{3}{*}{$s=16$}
            ...
            & KCMamba   & \textbf{0.05} & \textbf{0.23} & 0.46 & 0.59 & \textbf{+982\%} \\
        \hline
    \end{tabular}
    \caption{MSE értékek az ETTh2 adatkészleten. A KCMamba nyeri a $s=16$ versenyt $\sigma=5$-nél (0.59 vs Fair 3.11).}
    \label{tab:etth2}
\end{table}
