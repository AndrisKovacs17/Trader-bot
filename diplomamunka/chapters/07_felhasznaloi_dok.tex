...
\end{verbatim}
  ML-csomagok (opcionális, GPU-s benchmark futtatáshoz):
\begin{verbatim}
...
\begin{table}[H]
  ...
  \begin{tabular}{|p{4.4cm}|p{3.2cm}|p{5.8cm}|}
    ...
    \hline
    \texttt{ModuleNotFoundError: pandas} & Hiba & A venv nem látja a rendszer csomagjait; futtasd: \texttt{pip install --ignore-installed -r requirements.txt} \\
    \hline
