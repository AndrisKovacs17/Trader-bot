...
\begin{itemize}
    \item A \textbf{KCMamba} architektúra bemutatása, amely tanult
          $Q_\text{net}$, $R_\text{net}$ és $K_\text{net}$ alhálózatokat ágyaz
          be egy differenciálható Kalman-szűrőbe, és a rekurzió kiértékelését
          párhuzamos prefix-scan alapú GPU-implementációval gyorsítja.
