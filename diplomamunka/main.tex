...
% ------------------------------------------------------------
\title{KCMamba: Kalman-vezérelt szelektív állapottér-modell\\
       robusztus idősor-előrejelzésre}
\date{2026}
...
jelent. Az EC-MSE (Efficiency-Corrected MSE) metrika szerint, amely a
paraméterszámot, a VRAM-igényt és a futási időt is figyelembe veszi, a
KCMamba 24 konfigurációból 18-ban bizonyult a legelőnyösebbnek.
...
% ---- Ábrajegyzék (opcionális) ------------------------------
\phantomsection
\addcontentsline{toc}{chapter}{\lstfigurelabel}
\listoffigures
\cleardoublepage

% ---- Táblázatjegyzék, elhagyva --------------------------
% \phantomsection
